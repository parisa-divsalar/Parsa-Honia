        ...
        <Stack textAlign='center'>
          <Grid className={classes.steps} direction='row'>
            ...
            <Grid>
              ...
              >
                ...
                گرافیک است. این متن برای آزمایش چیدمان و نمایش متون در طراحی‌ها به کار می‌رود. هدف
                آن ایجاد نمونه‌ای از متن است که خوانایی و ظاهر طبیعی داشته باشد. هدف آن ایجاد
                نمونه‌ای از متن است که خوانایی و ظاهر طبیعی داشته باشد. هدف آن ایجاد نمونه‌ای از متن
                است که خوانایی و ظاهر طبیعی داشته باشد.
              </Typography>
            </Grid>
          </Grid>
          <Grid className={classes.steps} direction='row' mt={10}>
            <Grid ml={10}>
              ...
              <Typography textAlign='justify' variant='subtitle1' color='text.opacity' mt={1}>
                لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان
                گرافیک است. این متن برای آزمایش چیدمان و نمایش متون در طراحی‌ها به کار می‌رود. هدف
                آن ایجاد نمونه‌ای از متن است که خوانایی و ظاهر طبیعی داشته باشد. هدف آن ایجاد
                نمونه‌ای از متن است که خوانایی و ظاهر طبیعی داشته باشد. هدف آن ایجاد نمونه‌ای از متن
