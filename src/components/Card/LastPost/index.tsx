		...
		<Stack>
			<Link href='/blog/1'>
				<Grid className={classes.section_item} width='100%' p={{lg:4}}>
					<Stack  className={classes.section_item_image} width={{xs:'100%',lg:"420px"}} height={{xs:'200px',lg:"240px"}} position="relative">
					...
					<Grid className={classes.section_item_text}>
						...
						<Typography position='relative' textAlign='start' variant='subtitle1' color='text.primary' mt={1}>
							{title}
							<Stack position='absolute' left={{xs:0 ,lg:'-40px'}} top='1px'>
								<AppImage src={`/images/blog/Icon-wrap${theme === 'dark' ?"" : "-b"}.png`} title='' width={24} height={24} />
							</Stack>
						</Typography>
