...
const ServiceCard = ({title, des, img}: { title: string, des: string, img: string }) => {
	// @ts-ignore
	return (
		<Stack bgcolor='background.paper' direction='row' className={classes.backUp_item} width='100%' p={2}>
			<Stack mt={1} ml={1} position='relative' direction='row'   width={{xs:170 ,lg:60}} height={{xs:48 ,lg:60}}>
