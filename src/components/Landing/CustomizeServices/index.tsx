...
const CustomizeServicesSection = () => {
  return (
    <Container maxWidth='xl'>
      <Stack className={classes.customizeServices_section} mt={{xs:5 ,lg:15}} textAlign='center'>
        <Typography textAlign='center' variant='h4' color='text.primary' mt={1} width='100%'>
          پروژه های پارسا هونیا     </Typography>
        <Typography
          mb={{lg:5}}
          textAlign='center'
          variant='subtitle1'
          ...
          width='100%'
        >
            شرکت پارسا هونیا طراح و مجری بیش از 80 مگاوات نیروگاه گازی و تولید همزمان برق و حرارت می باشد. لیست برخی از پروژه ها در ادامه آورده شده است:
        ...
        >
          <Grid className={classes.customizeServices}>
			...
			<Stack mt={{xs:2 , lg:0}} ml={2} position='relative' direction='row'   width={{xs:'100%' ,lg:609}} height={{xs:200 ,lg:423}}>
